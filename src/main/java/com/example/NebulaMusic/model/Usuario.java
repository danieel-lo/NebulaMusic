...
public class Usuario {
    ...
    public Usuario(String nombre, String correo, String contrasenia, String txt_pseudonimo, String rad_genero,
                   String sel_suscripcion, String fechaNacimiento, String comentarios, String chk_terminos) {
        this.nombre = nombre;
        this.correo = correo;
